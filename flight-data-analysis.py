...
# Load datasets
flights_df = spark.read.csv("/workspaces/assignment-4-advanced-spark-sql-on-flight-data-LUCKYprog/flights.csv", header=True, inferSchema=True)
airports_df = spark.read.csv("/workspaces/assignment-4-advanced-spark-sql-on-flight-data-LUCKYprog/airports.csv", header=True, inferSchema=True)
carriers_df = spark.read.csv("/workspaces/assignment-4-advanced-spark-sql-on-flight-data-LUCKYprog/carriers.csv", header=True, inferSchema=True)
